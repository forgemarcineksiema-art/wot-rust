//! Multi-angle T-54 studio render: front, top-down, three-quarter and side into separate PNGs, so
//! the turret/mantlet casting is judged from every revealing angle — not just the flattering profile.
