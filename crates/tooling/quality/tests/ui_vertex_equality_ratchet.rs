...
const VERTEX_EQUALITY_CEILINGS: &[(&str, usize, Hold)] = &[
    ...
    ("crates/apps/client/src/hud/crew_panel.rs", 5, Hold::Burn),
    ...
    ("crates/apps/client/src/hud/module_panel.rs", 3, Hold::Burn),
...
const LEGACY_CALL_SITE_CEILINGS: &[(&str, usize, Hold)] = &[
    ...
    ("crates/apps/client/src/hud/crew_panel.rs", 2, Hold::Burn),
    ...
    ("crates/apps/client/src/hud/module_panel.rs", 2, Hold::Burn),
    ("crates/apps/client/src/hud/number.rs", 1, Hold::Burn),
    ("crates/apps/client/src/hud/outcome.rs", 3, Hold::Burn),
    ("crates/apps/client/src/hud/pause_menu.rs", 7, Hold::Burn),
    ("crates/apps/client/src/hud/rack_callout.rs", 3, Hold::Burn),
    ...
    ("crates/apps/client/src/hud/track_callout.rs", 3, Hold::Burn),
];
