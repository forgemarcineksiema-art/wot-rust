...
pub use scene_renderer::{
    SCENE_INSTANCE_CAPACITY, VEHICLE_INSTANCE_CAPACITY, armor_damage_aperture_budget,
    armor_damage_header_budget, fx_vertex_budget, scene_instance_budget, vehicle_instance_budget,
};
