...
/// `cargo run -p client --example probe -- t34_85_probe -- out.png`
pub(crate) fn run() -> Result<(), Box<dyn std::error::Error>> {
    let path = crate::sub_arg(1).unwrap_or_else(|| "target/t34_85_probe.png".to_string());
    let width = 1280u32;
    let height = 720u32;
    ...
    let snapshot = TankSnapshot {
        ...
        module_hit_points: VehicleKind::T34_85.spec().module_health.hit_points_by_slot(),
