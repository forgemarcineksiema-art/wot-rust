...
//! ```text
//! WOT_SHADOW_RES=2048 WOT_SHADOW_FOCUS=64 cargo run -p client --example shadow_probe
//! WOT_SHADOW_RES=8192 WOT_SHADOW_FOCUS=64 cargo run -p client --example shadow_probe
//! WOT_SHADOW_RES=2048 WOT_SHADOW_FOCUS=16 cargo run -p client --example shadow_probe
//! ```
