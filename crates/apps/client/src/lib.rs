...
pub use scene_build::battlefield::{
    ...
    battlefield_statics_bucket_mesh_with_falls, battlefield_statics_buckets,
    battlefield_statics_mesh, battlefield_statics_mesh_with_scars,
...
pub use vehicle::render_frame::{
    GroundTruth, VEHICLE_GUN_OBJECT, VEHICLE_HULL_OBJECT, VEHICLE_TURRET_OBJECT,
    VehicleRenderFrame, armor_damage_instance, render_frame_from_objects,
    split_pbr_vehicle_render_frame, split_pbr_vehicle_render_frame_on_terrain,
