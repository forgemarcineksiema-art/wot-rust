...
fn armor_profile_for(kind: VehicleKind, modules: &VehicleModules) -> ArmorProfile {
    ...
    match kind {
        ...
        VehicleKind::TigerII => ArmorProfile::new_with_facets(
            facet(h.front_mm, 50.0),
            facet(h.side_mm, 0.0),
            facet(h.rear_mm, 0.0),
            weakspot(t.front_mm, 12.0, 0.9),
            facet(t.side_mm, 0.0),
            facet(t.rear_mm, 0.0),
        ),
        VehicleKind::Jagdtiger => ArmorProfile::new_with_facets(
            facet(h.front_mm, 45.0),
            facet(h.side_mm, 0.0),
            facet(h.rear_mm, 0.0),
            weakspot(t.front_mm, 15.0, 0.95),
            facet(t.side_mm, 5.0),
            facet(t.rear_mm, 0.0),
        ),
        VehicleKind::PantherII => ArmorProfile::new_with_facets(
            facet(h.front_mm, 55.0),
            facet(h.side_mm, 0.0),
            facet(h.rear_mm, 0.0),
            weakspot(t.front_mm, 20.0, 0.9),
            facet(t.side_mm, 0.0),
            facet(t.rear_mm, 0.0),
        ),
