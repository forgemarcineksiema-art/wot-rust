...
impl RoundId {
    ...
    pub fn spec(self) -> ShellSpec {
        let spec = match self {
            // ——— 100 mm D-10 family ———
            // BR-412 APBC, 15.7 kg at 895 m/s (sourced, high confidence).
            ...
            // more penetration, less per-shot alpha (a sidegrade, not an upgrade).
            RoundId::Br412D => ShellSpec::armor_piercing(100.0, 895.0, 195.0, 300),
            // BK-5 HEAT: 280 mm flat with range; a spaced screen kills the jet.
            RoundId::Bk5 => ShellSpec::heat(100.0, 900.0, 280.0, 320),
            ...
            RoundId::Br365P => ShellSpec::apcr(85.0, 1_050.0, 170.0, 170),
            ...
            // ——— 8.8 cm KwK 36 L/56 ———
            RoundId::Pzgr39 => ShellSpec::armor_piercing(88.0, 773.0, 165.0, 360),
            ...
            // KwK 36's own AP and the KwK 43's sourced 40/43.
            RoundId::Pzgr40 => ShellSpec::apcr(88.0, 930.0, 217.0, 320),
            ...
            // Pzgr 40/43 at its sourced 1,130 m/s; the 100 m penetration is a balance decision
            // (the sourced tables start at 500 m).
            RoundId::Pzgr40_43 => ShellSpec::apcr(88.0, 1_130.0, 237.0, 330),
            // ——— 12.8 cm Pak 80 L/55 ———
            RoundId::Pzgr43 => ShellSpec::armor_piercing(128.0, 920.0, 223.0, 530),
            // The 28 kg HE shell is sourced; its velocity and filler are dossier GAPs filled as
            // a decision.
            RoundId::SprgrPak80 => ShellSpec::high_explosive(128.0, 750.0, 43.0, 520, 2.2),
            // ——— 7.5 cm KwK 42 L/70 ———
            RoundId::Pzgr39_42 => ShellSpec::armor_piercing(75.0, 935.0, 138.0, 240),
            // Pzgr 40/42, fully sourced: 4.75 kg at 1,120 m/s for 194 mm at 100 m.
            RoundId::Pzgr40_42 => ShellSpec::apcr(75.0, 1_120.0, 194.0, 200),
            // Sprgr 42: 5.74 kg at 700 m/s (sourced); filler is a GAP, damage set from class.
            RoundId::Sprgr42 => ShellSpec::high_explosive(75.0, 700.0, 25.0, 250, 1.4),
            // ——— 84 mm 20-pounder ———
            RoundId::TwentyPdrApcbc => ShellSpec::armor_piercing(84.0, 1_020.0, 230.0, 240),
            // APDS at a sourced 1,465 m/s for ~300 mm — the gun's NORMAL load.
            RoundId::TwentyPdrApds => ShellSpec::apcr(84.0, 1_465.0, 300.0, 220),
            // HE attested, numbers not: velocity, mass and filler are GAPs — a balance decision
            // at the 84 mm class.
            RoundId::TwentyPdrHe => ShellSpec::high_explosive(84.0, 850.0, 28.0, 290, 1.6),
            // ——— 120 mm Prototype (fictional) ———
            RoundId::Prototype120Ap => ShellSpec::armor_piercing(120.0, 900.0, 250.0, 390),
            RoundId::Prototype120Apcr => ShellSpec::apcr(120.0, 1_000.0, 300.0, 330),
