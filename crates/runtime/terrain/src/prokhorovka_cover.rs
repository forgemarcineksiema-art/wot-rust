...
pub(crate) fn static_cover_objects(heightmap: &HeightMap) -> Vec<StaticCoverObject> {
    ...
    vec![
        ...
        // The yard fences (Fizyczny Świat P10): wooden runs closing each zagroda — flimsy,
        // crushable, and mirror-paired like everything else on the steppe.
        grounded_cover(
            heightmap,
            "oktyabrskiy_yard_fence_south",
            "Oktyabrskiy Farm south yard fence",
        ...
        grounded_cover(
            heightmap,
            "oktyabrskiy_yard_fence_north",
            "Oktyabrskiy Farm north yard fence",
            StaticCoverKind::WoodenFence,
            [479.0, 552.5],
            [8.5, 0.65, 0.25],
        ),
        grounded_cover(
            heightmap,
            "oktyabrskiy_side_fence_south",
            "Oktyabrskiy Farm south side fence",
            StaticCoverKind::WoodenFence,
            [461.5, 466.0],
            [0.25, 0.65, 7.0],
        ),
        grounded_cover(
            heightmap,
            "oktyabrskiy_side_fence_north",
            "Oktyabrskiy Farm north side fence",
            StaticCoverKind::WoodenFence,
            [461.5, 534.0],
            [0.25, 0.65, 7.0],
        ),
