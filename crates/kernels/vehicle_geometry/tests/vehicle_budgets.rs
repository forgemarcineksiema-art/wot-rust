...
fn every_vehicle_bake_hash_matches_golden_output() {
    let expected = [
        ...
        // Re-recorded for the visible pike bow: the IS-3 hull is now authored face by face on
        // the armor-volume planes (see recipes/is3.rs); the existing fleet is untouched.
        (VehicleKind::IS3, 13_079_411_250_306_693_935_u64),
    ];
