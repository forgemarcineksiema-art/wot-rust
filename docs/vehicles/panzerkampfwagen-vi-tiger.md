...
| Width over the combat tracks | 3.548 m (STT 1944: 6 ft 10.625 in between the belts + 2 x 2 ft 4.5 in) | STT sheet; see conflict C1 (the 3.705/3.72 records are guard widths) | high | `track.outer_x 1.774`; the belts run under the guards (`HullWidth` measures the guards, 3.734) |
...
| Upper hull box (the driver's plate, the hull sides above the sponson) | 3.18 m (STT 1944 front view: 885 px at 278 px/m; the Tank Museum's 3547 mm is the belts) | STT sheet | high | `half_width 1.59`; the belts run outside the box under the guards |
| Width over the track guards (Kettenabdeckung) | 3.734 m (STT 1944 front view: 12 ft 3 in, the sheet's own dimension); the guard rail's bolt row ~1.40 m up the hull side (side view); four hinged sections a side | STT sheet | high | `visual.fender` side_x 1.7285 / center_y 1.39 / half (0.1385, 0.008, 2.60) — the library's folded pressings (K3-2e); `HullWidth` 3.734 +/-0.03 (Locked) |
...
| Width over combat tracks | 3.548 m (STT) | `track.outer_x 1.774` (under the guards) |
| Width over the track guards | 3.734 m (STT front view, 12 ft 3 in) | `visual.fender` 1.7285 +/- 0.1385, at 1.39 (K3-2e) |
| Upper hull box | 3.18 m (STT front view) | `half_width 1.59` (the belts run outside it under the guards) |
