...
clouds, a wholly procedural flora stack, PBR vehicles with baked cavity AO. It also has a written
...
| ~~D5~~ | ~~**Every** battle tree is pinned to `TreeLod::Mid`~~ — **CLOSED (Świat 2.0 F0, F7, F7b 2026-09-04)**: every planted tree — free-standing species and TreeLine stations — draws through the instanced LOD ladder (`scene_build::tree_lod`) with Near/Mid/Impostor rungs from `world_forge::tree`; height locks stay in `tree.rs`. The stations' crown hull is its own instanced mesh on Near/Mid | `tree_lod.rs`, `tree.rs`, `tree_line.rs` | W2 |
...
| D33 | **The tiled ground material brightened the hall and weakened the studio's promise.** T3 (`51b8f224`, 2026-09-04) changed the terrain shader the hangar's floor and walls draw through and re-blessed the battlefield frames only; the eight garage frames stayed stale until the interface program's F1 bless (2026-09-05) re-recorded everything. Measured: the room's median rose 0.162 → 0.193 with the hero unchanged at 0.300, so hero-over-room fell 1.83× → 1.56× and the bless re-derived `HERO_OVER_ROOM` 1.7 → 1.5 in the open. The hero still leads its frame, by less. Whether the hall's floor darkens back is this register's decision, not a bless's | `crates/apps/client/tests/look_goldens.rs` (`HERO_OVER_ROOM`), `goldens/look/garage_hero.png`  **Decided 2026-09-07 (K24-1):** with the hero in its nation's coat instead of the pale showroom tint (which had been buying the margin: 0.300 over 0.193), it read 1.08× — and the key stays where the 2026-08-10 verdict put it. The hall darkened: concrete 0.30 → 0.18, whitewash 0.38 → 0.25, joints 0.235 → 0.17; the hero leads its room again above 1.5×; the German heroes' floors re-derived at the coat and the hall | `crates/apps/client/tests/look_goldens.rs` (`HERO_OVER_ROOM`), `goldens/look/garage_hero.png` | W4 |
...
Re-measured 2026-09-04 (pine retired, then F7b): 26 battlefield frames re-recorded twice
the same day. First the pine left the atlas; then TreeLine stations left statics and ride
the ladder (Near up close with a hull, impostor past 300 m). Value floors held without
relaxation. The garage half was not re-recorded.

_Re-measured 2026-09-05 at the interface program's F1 bless (all 34 frames re-recorded; the previous table dated from T3's battlefield-only bless of 2026-09-04)._

| frame | dark | mid | bright | p05 | p50 | p95 | spread | sat | local | band |
|---|---|---|---|---|---|---|---|---|---|---|
| `prokhorovka_clear_afternoon` | 2.1% | 61.7% | 36.2% | 0.371 | 0.517 | 0.849 | 0.478 | 0.341 | 0.0074 | +0.232 |
| `prokhorovka_golden_evening` | 41.3% | 25.2% | 33.5% | 0.135 | 0.358 | 0.701 | 0.566 | 0.348 | 0.0069 | +0.371 |
| `prokhorovka_overcast` | 1.7% | 49.8% | 48.5% | 0.364 | 0.506 | 0.720 | 0.356 | 0.176 | 0.0064 | +0.261 |
| `prokhorovka_evening_midfield` | 38.3% | 28.3% | 33.5% | 0.103 | 0.285 | 0.715 | 0.612 | 0.383 | 0.0065 | +0.384 |
| `prokhorovka_grass_midfield` | 6.0% | 56.6% | 37.4% | 0.094 | 0.541 | 0.835 | 0.741 | 0.354 | 0.0092 | +0.195 |
| `prokhorovka_contact_backlit` | 19.6% | 59.8% | 20.6% | 0.042 | 0.473 | 0.810 | 0.768 | 0.400 | 0.0059 | +0.307 |
| `prokhorovka_evening_contact` | 40.1% | 35.1% | 24.8% | 0.110 | 0.269 | 0.700 | 0.591 | 0.413 | 0.0062 | +0.350 |
| `prokhorovka_sniper_contact` | 20.2% | 56.7% | 23.0% | 0.037 | 0.499 | 0.737 | 0.700 | 0.365 | 0.0127 | +0.221 |
| `bystra_clear_afternoon` | 14.5% | 54.9% | 30.6% | 0.040 | 0.325 | 0.719 | 0.679 | 0.387 | 0.0099 | +0.371 |
| `bystra_rain` | 11.3% | 53.4% | 35.3% | 0.032 | 0.388 | 0.683 | 0.651 | 0.249 | 0.0080 | +0.304 |
| `bystra_dawn_fog` | 25.1% | 38.4% | 36.5% | 0.038 | 0.302 | 0.763 | 0.726 | 0.275 | 0.0094 | +0.417 |
| `bystra_town_lane` | 24.4% | 54.0% | 21.6% | 0.072 | 0.332 | 0.710 | 0.638 | 0.350 | 0.0098 | +0.266 |
| `orliny_clear_afternoon` | 9.5% | 58.3% | 32.2% | 0.202 | 0.341 | 0.781 | 0.579 | 0.341 | 0.0070 | +0.426 |
| `orliny_golden_evening` | 51.7% | 13.8% | 34.5% | 0.131 | 0.246 | 0.806 | 0.675 | 0.321 | 0.0068 | +0.537 |
| `orliny_overcast` | 2.7% | 54.4% | 42.8% | 0.330 | 0.424 | 0.721 | 0.391 | 0.187 | 0.0065 | +0.286 |
| `orliny_dawn_fog` | 23.9% | 34.9% | 41.2% | 0.161 | 0.275 | 0.723 | 0.562 | 0.226 | 0.0060 | +0.437 |
| `orliny_pine_belt` | 17.0% | 58.0% | 25.1% | 0.008 | 0.332 | 0.717 | 0.709 | 0.375 | 0.0097 | +0.273 |
| `ostrogorsk_clear_afternoon` | 26.1% | 54.4% | 19.5% | 0.010 | 0.479 | 0.818 | 0.808 | 0.400 | 0.0171 | +0.127 |
| `ostrogorsk_golden_evening` | 47.6% | 32.3% | 20.1% | 0.005 | 0.253 | 0.779 | 0.774 | 0.432 | 0.0147 | +0.369 |
| `ostrogorsk_overcast` | 26.7% | 48.5% | 24.8% | 0.012 | 0.435 | 0.713 | 0.701 | 0.263 | 0.0146 | +0.247 |
| `ostrogorsk_rain` | 26.2% | 49.6% | 24.2% | 0.015 | 0.399 | 0.676 | 0.661 | 0.252 | 0.0136 | +0.250 |
| `ostrogorsk_canyon` | 7.8% | 69.0% | 23.2% | 0.208 | 0.448 | 0.842 | 0.634 | 0.230 | 0.0079 | +0.237 |
| `mazurski_clear_afternoon` | 33.6% | 42.8% | 23.6% | 0.002 | 0.391 | 0.712 | 0.711 | 0.388 | 0.0114 | +0.168 |
| `mazurski_overcast` | 28.9% | 41.9% | 29.2% | 0.009 | 0.336 | 0.747 | 0.738 | 0.310 | 0.0112 | +0.310 |
| `mazurski_golden_evening` | 35.0% | 39.2% | 25.8% | 0.001 | 0.310 | 0.718 | 0.717 | 0.409 | 0.0116 | +0.247 |
| `mazurski_causeway` | 9.6% | 54.4% | 35.9% | 0.147 | 0.363 | 0.774 | 0.627 | 0.372 | 0.0090 | +0.409 |
| `garage_hero` | 65.6% | 29.6% | 4.8% | 0.043 | 0.193 | 0.593 | 0.549 | 0.214 | 0.0081 | −0.149 |
| `garage_screen` | 72.5% | 22.9% | 4.6% | 0.079 | 0.150 | 0.581 | 0.502 | 0.182 | 0.0107 | −0.126 |
| `garage_tech_tree` | 73.5% | 24.2% | 2.3% | 0.081 | 0.141 | 0.507 | 0.426 | 0.180 | 0.0062 | −0.135 |
| `garage_option_list` | 74.0% | 21.4% | 4.6% | 0.079 | 0.144 | 0.583 | 0.503 | 0.183 | 0.0109 | −0.110 |
| `garage_susp_close` | 81.3% | 18.7% | 0.0% | 0.054 | 0.131 | 0.360 | 0.307 | 0.397 | 0.0066 | +0.092 |
| `garage_hero_tiger2` | 60.9% | 36.2% | 2.9% | 0.039 | 0.204 | 0.549 | 0.510 | 0.223 | 0.0075 | −0.203 |
| `garage_hero_jagdtiger` | 58.3% | 38.8% | 2.9% | 0.038 | 0.211 | 0.543 | 0.505 | 0.223 | 0.0078 | −0.258 |
| `garage_inspector` | 61.4% | 32.1% | 6.4% | 0.044 | 0.200 | 0.626 | 0.582 | 0.241 | 0.0077 | −0.175 |

### What the baseline says

*(Reading of 2026-08-09; figures refreshed 2026-08-22 against the re-blessed table above. The
W1 air + light passes moved the milk, so per this section's own rule the numbers were
re-derived — the diagnosis and its direction survived the re-measure unchanged.)*

**The evening looks are not the problem.** `prokhorovka_evening_contact` (48.7% dark, spread
0.628), `orliny_golden_evening` (47.8%, 0.683) and `ostrogorsk_golden_evening` (38.8%, 0.686) all
...
`prokhorovka_clear_afternoon` holds **1.0% dark against 36.7% bright**, with p05 at **0.345** —
even the darkest twentieth of the frame is mid-grey. `prokhorovka_overcast` is the flattest
picture in the set at spread 0.367. That is the milk, quantified: not a colour problem, a
*missing shade mass* problem. It is W1's whole job (D3, D4).

**Two looks are thin in the middle.** `orliny_golden_evening` (17.2% mid) and
`ostrogorsk_golden_evening` (24.7%) read bimodal — lit or black, with little in between. Watch
...
concentrated in the clear and overcast days — and it is a *shade* debt, not a colour one: nine
of the fourteen lines are the dark plane.

The two worst offenders are the two flattest pictures in the set, and they are the same two the
baseline named: `prokhorovka_overcast` (short 0.073 dark and 0.082 spread) and
...
D21 said cloud shadows never ran in the shipped tier (closed since — the shade ships), and the
arithmetic says D4 cannot close without them. So the buy-back was measured rather than argued, one variable at a time via the new
...
clump the grass (D7) — all closed; D14 died with the import pipeline. The honesty doctrine binds here: a
...
the dirt lane wired into battle (D9), the showcase showing paint (D17). D10 (the team-colour key)
closed early, by PR #317.
...
crop now, and it measures **median 0.161 against the room's 0.089, 1.83x at E3**, floored at 1.4x
