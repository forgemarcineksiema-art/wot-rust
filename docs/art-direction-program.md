...
| D6 | Three content kinds still render as a bare cuboid in Cover 2.0 scope: `TreeLine`, `RailCover`, and `SceneryKind::Rock` — **there is no rock generator**. `Wreck` stays a footprint box (out of Świat 2.0, 2026-08-07). Moves under `docs/world-2.0-program.md` (Cover 2.0 wave) | `battlefield.rs`, `foliage.rs` | W2 |
