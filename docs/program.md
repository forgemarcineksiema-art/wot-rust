...
Inherited: ~~B1 (eaves and ridges)~~, ~~B2 (ground connection)~~ (its dirt apron deferred), ~~B3 (kit of parts, instanced)~~, ~~B4 (coursing and streaks)~~, ~~B5 (a ruin with form)~~, B6 (variety: L-shapes, annexes, terraces). B3 first. Plus:
