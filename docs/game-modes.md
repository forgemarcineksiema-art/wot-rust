...
M5's optimisation, done before the format meets its first humans (finding 3). None of it starts
before the owner's word: documents only (2026-09-06).
