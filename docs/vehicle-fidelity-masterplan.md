...
| Jagdtiger | ✓ PR-JT.1 (#244) | ✓ 5 dims + 7 ratios tightened | ✓ plain muzzle + cast collar + side racks + guards + Kugelblende (#245); **JT.3**: collar re-cut to stand 0.22 m PROUD, casemate face squared to full deck width, crewed roof, six-shoe racks, hull-flank stowage | ✓ fleet passes #233–#238 | — (shares blueprint part path) | ✓ 12 tests incl. JT.2 dressing + JT.3 relief/width/roof/flank locks | close-up reviewed (flank/front/casemate); NOT declared — user review pending |
