...
| 36 (2026-09-09) | §2 minimum hardware/60 FPS, row 2's MX330 floor and the one-look rule | A canonical picture exists, but the owner reports worsening FPS through the battle, preventing aiming; recorded 2026-09-08 runs exceed the budget | **The owner: stable 60 FPS on the MX330 laptop is sufficient; stronger PCs should deliver more FPS with one intended look on every supported PC.** Preserve combat visibility, world presence and readability; no quality preset may remove cover/foliage for an advantage. Resolution and FPS may differ after validation. Sustained late-battle control is the priority, not startup/average FPS. This is an accepted target, not achieved performance. [One-look policy](one-look-policy.md), [sustained-performance plan](sustained-performance-plan.md); `program.md` Q11–Q16. Numerical acceptance thresholds are the plan's engineering targets, not measurements or a verbatim owner instruction |
